...
```bash
git remote add encore encore://infographic-generator-app-b8t2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/infographic-generator-app-b8t2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/infographic-generator-app-b8t2/settings/integrations/github)
